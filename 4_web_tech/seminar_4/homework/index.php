    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-third">
        <div class="w3-white w3-text-grey w3-card-4">
          ...
          <div class="w3-container">
            ...
            <p><i class="fa fa-phone fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $phone_num ?></p>
            <hr>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <?php foreach($job_experience as $job):?>
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $job['job']?> </b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $job['start']?> - <span
                <?php if ($job['end'] == 'Current') {?>
                class="w3-tag w3-teal w3-round"><?php echo $job['end']?></span></h6>
                <?php } else {?>
                class="w3-margin-right"><?php echo $job['end']?></span></h6>
                <?php }?>
